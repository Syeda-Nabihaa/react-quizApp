          ...
          <tbody>
            {questions.map((question) => (
              <tr key={question.id} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                ...
                <td className="px-7 py-4 text-blue-600">{question.option1}</td>
                <td className="px-6 py-4 text-blue-600">{question.option2}</td>
                <td className="px-6 py-4 text-blue-600">{question.option3}</td>
                <td className="px-6 py-4 text-blue-600">{question.option4}</td>
                <td className="px-6 py-4 text-green-600 font-bold">{question.answer}</td>
              </tr>
            ))}
          </tbody>
        </table>
